# class Carditem():
#     #class attribute  == sınıfa has özellikleri tanımladığımız yer. Diğer methodların dışında ama sınıfın içinde
#     discount_rate = 0.2
#     item_count = 1

#     def __init__(self, name, price, quantity):  #self nesneler için kullanılıyor onlara erişmek için.
#         self.name = name      #instances attritubes  = nesneye has özellikler 
#         self.price = price
