# # @classmethod  # @classmethod yazıyorsa bu method nesneye değil sınıfın kendisine hizmet ediyor demektir. Parametre olarak self almaz.
# # cls yi parametre olarak alır.
...
#         return (f"{cls.itemcount} tane ürün sepete eklendi.")
...
# item1 = Carditem("Telefon", 10000, 2)
# item2 = Carditem("Bilgisayar", 70000, 3)
# item3 = Carditem("Tablet", 20000, 3)

# print(Carditem.display_count())
# print(Carditem.display_rate())
